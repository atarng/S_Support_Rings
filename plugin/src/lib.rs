...
{unsafe{
    println!("[unit_updatestateimpl]-------------------------------------------------------------------");
    if let Some(equipped_unwrapped) = equipped {
        println!("[unit_updatestateimpl] is_auto_equip: {} equipped: {}", is_auto_equip, equipped_unwrapped.item.fields.iid);
    }
    ...
    let hp_before = this.fields.hp_value;
    let hp_max_bf = unit_getmaxhp(this, _method_info);

    call_original!(this, is_auto_equip, equipped, _method_info);
    println!("[unit_updatestateimpl/{}/hp-after_original] hp: {} -> {} hp-d: {} maxhp: {} -> {}",
        this.get_pid(), this.fields.hp_value, hp_before, this.fields.hp_display,
        hp_max_bf, unit_getmaxhp(this, _method_info)
    );

    if let Some(calculator) = this.fields.enhance_calculator {
        // UnitEnhanceValues
        // This appears to get Previous Character emblem?
        if let Some(calculator_temp) = calculator.fields.temp {
            println!("[unit_updatestateimpl] temp: hp:{}/st:{}/sk:{}/sp:{}/lk:{}/d:{}/ma:{}/r:{}/b:{}/mv:{}",
                calculator_temp.get_item(0 as i32),
                calculator_temp.get_item(1 as i32),
                calculator_temp.get_item(2 as i32),
                calculator_temp.get_item(3 as i32),
                calculator_temp.get_item(4 as i32),
                calculator_temp.get_item(5 as i32),
                calculator_temp.get_item(6 as i32),
                calculator_temp.get_item(7 as i32),
                calculator_temp.get_item(8 as i32),
                calculator_temp.get_item(10 as i32)
            );
        }
        if let Some(calculator_values) = calculator.fields.values {
            println!("[unit_updatestateimpl] values: hp:{}/st:{}/sk:{}/sp:{}/lk:{}/d:{}/ma:{}/r:{}/b:{}/mv:{}",
                calculator_values.get_item(0 as i32),
                calculator_values.get_item(1 as i32),
                calculator_values.get_item(2 as i32),
                calculator_values.get_item(3 as i32),
                calculator_values.get_item(4 as i32),
                calculator_values.get_item(5 as i32),
                calculator_values.get_item(6 as i32),
                calculator_values.get_item(7 as i32),
                calculator_values.get_item(8 as i32),
                calculator_values.get_item(10 as i32)
            );
        }
    }
    ...
    if let Some(_god) = this.get_god_unit() {
        ...
        if let Some(enhancements_unwrapped) = ringdata_getenhance(ring_data, _method_info) {
            let _hp  = capabilitybase_sbyte_gethp(enhancements_unwrapped, _method_info);  // 0
            let _str = capabilitybase_sbyte_getstr(enhancements_unwrapped, _method_info); // 1
            let _skl = capabilitybase_sbyte_getskl(enhancements_unwrapped, _method_info); // 2
            let _spd = capabilitybase_sbyte_getspd(enhancements_unwrapped, _method_info); // 3
            let _lck = capabilitybase_sbyte_getlck(enhancements_unwrapped, _method_info); // 4
            let _def = capabilitybase_sbyte_getdef(enhancements_unwrapped, _method_info); // 5
            let _mag = capabilitybase_sbyte_getmag(enhancements_unwrapped, _method_info); // 6
            let _res = capabilitybase_sbyte_getres(enhancements_unwrapped, _method_info); // 7
            let _bld = capabilitybase_sbyte_getbld(enhancements_unwrapped, _method_info); // 8
            let _mov = capabilitybase_sbyte_getmov(enhancements_unwrapped, _method_info); // 10
            println!("[unit_updatestateimpl] enhancements:: hp:{}/st:{}/sk:{}/sp:{}/lk:{}/d:{}/ma:{}/r:{}/b:{}/mv:{}",
                _hp, _str, _skl, _spd, _lck, _def, _mag, _res, _bld, _mov);

            // if let Some(enhance_factors_unwrapped) = this.get_enhance_factor() {
            //     if let Some(enhance_food_unwrapped) = enhance_factors_unwrapped.get_food_values() {
            //         if let Some(i32array) = &enhance_food_unwrapped.values {
            //             println!("[unit_updatestateimpl] enhance factors food: {}", i32array.len());
            //             for i in 0..i32array.len() {
            //                 println!("unit_updatestateimpl] temp[{}] {}", i, enhance_food_unwrapped.get_item(i as i32));
            //             }
            //         }
            //     }
            // }
            ...
            if let Some(calculator) = this.fields.enhance_calculator {
                ...
                println!("[unit_updatestateimpl/{}/hp-aftercalculator] hp: {} hp_max: {}",
                        this.get_pid(), this.fields.hp_value, unit_getmaxhp(this, _method_info));

                // if let Some(calculator_temp) = calculator.fields.temp {
                //     unitenhancevalues_add2(calculator_temp, Some(enhancements_unwrapped), false,  _method_info);
                //     println!("[unit_updatestateimpl/{}/hp-aftertemp] hp: {} hp_max: {}",
                //             this.get_pid(), this.fields.hp_value, unit_getmaxhp(this, _method_info));
                //     println!("[unit_updatestateimpl] temp: hp:{}/st:{}/sk:{}/sp:{}/lk:{}/d:{}/ma:{}/r:{}/b:{}/mv:{}",
                //         calculator_temp.get_item(0 as i32),
                //         calculator_temp.get_item(1 as i32),
                ...
                if let Some(calculator_values) = calculator.fields.values {
                    ...
                    println!("[unit_updatestateimpl/{}/hp-aftervalues] hp: {} hpmax: {}",
                            this.get_pid(), this.fields.hp_value, unit_getmaxhp(this, _method_info));
                    println!("[unit_updatestateimpl] values: hp:{}/st:{}/sk:{}/sp:{}/lk:{}/d:{}/ma:{}/r:{}/b:{}/mv:{}",
                        calculator_values.get_item(0 as i32),
                        calculator_values.get_item(1 as i32),
    ...
    // println!("[unit_updatestateimpl/{}/before-original] hp: {} hpmax: {}",
    //     this.get_pid(), this.fields.hp_value, unit_getmaxhp(this, _method_info));

    // call_original!(this, is_auto_equip, equipped, _method_info);

    println!("[unit_updatestateimpl/{}/hp-END] hp: {} -> {} hp-d: {} maxhp: {} -> {}",
        this.get_pid(), this.fields.hp_value, hp_before, this.fields.hp_display,
        hp_max_bf, unit_getmaxhp(this, _method_info));
...
pub fn main() {
    ...
    ////////////// BEG: RESEARCH HOOKS ////////////////////////////////////
    install_hook!(unit_getmaxhp);
    install_hook!(unit_commitenhance);

    // install_hook!(unitenhancecalculator_addimpl);
    // install_hook!(unitenhancecalculator_calculate);
    // install_hook!(unitenhancecalculator_clear);
    // install_hook!(unitenhancecalculator_commit1st);
    // install_hook!(unitenhancecalculator_deserialize);
    // install_hook!(unitenhancecalculator_serialize);

    // install_hook!(unitenhancevalues_add1);
    // install_hook!(unitenhancevalues_add2);
    // install_hook!(unitenhancevalues_add3);
    // install_hook!(unitenhancevalues_add4);

    // this is causing a crash?
    // install_hook!(unitenhancefactors_getfoodvalues);
...
///////////////////////// UNIT ENHANCE RESEARCH //////////////////////////////

// 0x7101a2bcd0
// int32_t App.Unit$$GetMaxHp(App_Unit_o *__this,MethodInfo *method)
#[skyline::hook(offset=0x01a2bcd0)]
pub fn unit_getmaxhp(this: &Unit, _method_info : u64) -> i32 {
    return call_original!(this, _method_info);
    // println!("[unit_getmaxhp/BEG]");
    // let original_max_hp = call_original!(this, _method_info);
    // println!("[unit_getmaxhp/END]");
    // return original_max_hp;
}


// 0x7101a1aae0
// void App.Unit$$CommitEnhance(App_Unit_o *__this,App_UnitItem_o *equipped,MethodInfo *method)
#[skyline::hook(offset=0x01a1aae0)]
pub fn unit_commitenhance(this: &Unit, equipped: Option<&UnitItem>, _method_info : u64) {
    println!("[unit_commitenhance/BEG]");
    call_original!(this, equipped, _method_info);
    println!("[unit_commitenhance/END]");
}
...
// 0x7101f77d90
// void App.UnitEnhanceCalculator$$Clear(App_UnitEnhanceCalculator_o *__this,MethodInfo *method)
// #[skyline::hook(offset=0x01f77d90)]
// pub fn unitenhancecalculator_clear(this: &UnitEnhanceCalculator, _method_info : u64) {
//     println!("[unitenhancecalculator_clear/BEG]");
//     call_original!(this, _method_info);
//     println!("[unitenhancecalculator_clear/END]");
// }

// 0x7101f781f0
// void App.UnitEnhanceCalculator$$AddImpl(App_UnitEnhanceCalculator_o *__this,App_CapabilitySbyte_o *capability, bool isNotEnhance,MethodInfo *method)
// #[skyline::hook(offset=0x01f781f0)]
...
// {unsafe{
//     call_original!(this, capability, is_not_enhance, _method_info);    
// }}
#[skyline::from_offset(0x01f781f0)]
pub fn unitenhancecalculator_addimpl(this: &UnitEnhanceCalculator, capability: Option<&CapabilitySbyte>, is_not_enhance: bool, _method_info : u64);

// 0x7101f74b40
// void App.UnitEnhanceCalculator$$Commit1st(App_UnitEnhanceCalculator_o *__this,App_Unit_o *unit,App_UnitItem_o *equipped, MethodInfo *method)
// #[skyline::hook(offset=0x01f74b40)]
// pub fn unitenhancecalculator_commit1st(this: &UnitEnhanceCalculator, unit: Option<&Unit>, equipped: Option<&UnitItem>, _method_info : u64) {
//     println!("[unitenhancecalculator_commit1st/BEG]");
//     call_original!(this, unit, equipped, _method_info);
//     println!("[unitenhancecalculator_commit1st/END]");
// }

// 0x7101f78170
// int32_t App.UnitEnhanceCalculator$$Calculate(App_UnitEnhanceCalculator_o *__this,int32_t index,int32_t value,MethodInfo *method)
// #[skyline::hook(offset=0x01f78170)]
// pub fn unitenhancecalculator_calculate(this: &UnitEnhanceCalculator, index: i32, value: i32, _method_info : u64) {
//     println!("[unitenhancecalculator_calculate/BEG] {}: {}", index, value);
//     call_original!(this, index, value, _method_info);
//     println!("[unitenhancecalculator_calculate/END]");
// }

// 0x7101f793d0
// void App.UnitEnhanceCalculator$$Serialize(App_UnitEnhanceCalculator_o *__this,App_Stream_o *stream,MethodInfo *method)
// #[skyline::hook(offset=0x01f793d0)]
// pub fn unitenhancecalculator_serialize(this: &UnitEnhanceCalculator, stream: Option<&Stream>, _method_info : u64) {
//     println!("[unitenhancecalculator_serialize/BEG]");
//     call_original!(this, stream, _method_info);
//     println!("[unitenhancecalculator_serialize/END]");
// }

// 0x7101f795c0
// void App.UnitEnhanceCalculator$$Deserialize(App_UnitEnhanceCalculator_o *__this,App_Stream_o *stream,MethodInfo *method)
// #[skyline::hook(offset=0x01f795c0)]
// pub fn unitenhancecalculator_deserialize(this: &UnitEnhanceCalculator, stream: Option<&Stream>, _method_info : u64) {
//     println!("[unitenhancecalculator_deserialize/BEG]");
//     call_original!(this, stream, _method_info);
//     println!("[unitenhancecalculator_deserialize/END]");
// }

// 0x7101f7b270
// void App.UnitEnhanceValues$$Add(App_UnitEnhanceValues_o *__this,App_UnitEnhanceValues_o *values,bool isNotEnhance, MethodInfo *method)
// #[skyline::hook(offset=0x01f7b270)]
// pub fn unitenhancevalues_add1(this: &UnitEnhanceValues, values: Option<&UnitEnhanceValues>, is_not_enhance: bool, _method_info : u64) {
//     println!("[unitenhancevalues_add1/BEG]");
//     call_original!(this, values, is_not_enhance, _method_info);
//     println!("[unitenhancevalues_add1/END]");
// }

// 0x7101f7bd40
// void App.UnitEnhanceValues$$Add(App_UnitEnhanceValues_o *__this,App_CapabilitySbyte_o *capability, bool isNotEnhance, MethodInfo *method)
// #[skyline::hook(offset=0x01f7bd40)]
...
//     println!("[unitenhancevalues_add2/BEG]");
//     call_original!(this, capability, is_not_enhance, _method_info);
//     println!("[unitenhancevalues_add2/END]");
// }
#[skyline::from_offset(0x01f7bd40)]
pub fn unitenhancevalues_add2(this: &UnitEnhanceValues, capability: Option<&CapabilitySbyte>, is_not_enhance: bool, _method_info : u64);

// 0x7101f7c340
// void App.UnitEnhanceValues$$Add(App_UnitEnhanceValues_o *__this,App_CapabilitySbyte_o *capability,int32_t decay, bool isNotEnhance, MethodInfo *method)
// #[skyline::hook(offset=0x01f7c340)]
// pub fn unitenhancevalues_add3(this: &UnitEnhanceValues, capability: Option<&CapabilitySbyte>, decay: i32, is_not_enhance:bool, _method_info : u64) {
//     println!("[unitenhancevalues_add3/BEG]");
//     call_original!(this, capability, decay, is_not_enhance, _method_info);
//     println!("[unitenhancevalues_add3/END]");
// }

// 0x7101f7c4c0
// void App.UnitEnhanceValues$$Add(App_UnitEnhanceValues_o *__this,int32_t type,int32_t value,bool isNotEnhance, MethodInfo *method)
// #[skyline::hook(offset=0x01f7c4c0)]
// pub fn unitenhancevalues_add4(this: &UnitEnhanceValues, _type: i32, value: i32, is_not_enhance:bool, _method_info : u64) {
//     println!("[unitenhancevalues_add4/BEG]");
//     call_original!(this, _type, value, is_not_enhance, _method_info);
//     println!("[unitenhancevalues_add4/END]");
// }

// 0x7101f7aff0
// App_UnitEnhanceValues_o * App.UnitEnhanceFactors$$get_FoodValues(App_UnitEnhanceFactors_o *__this,MethodInfo *method) {
// #[skyline::hook(offset=0x01f7aff0)]
// pub fn unitenhancefactors_getfoodvalues(this: &UnitEnhanceFactors, _method_info : u64) -> Option<&UnitEnhanceValues> {
//     println!("[unitenhancefactors_getfoodvalues/BEG]");
//     let original = call_original!(this, _method_info);
//     println!("[unitenhancefactors_getfoodvalues/END]");
//     return original;
// }
